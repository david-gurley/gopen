...
> SecuritySecurityGroup GetSecurityGroup(ctx, oTenant).TKind(tKind).MetaCreationTime(metaCreationTime).SpecServiceLabels(specServiceLabels).Execute()
...
> SecuritySecurityGroup UpdateSecurityGroup(ctx, oTenant).Body(body).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.SecurityV1Api.UpdateSecurityGroup(context.Background(), oTenant).Body(body).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SecurityV1Api.UpdateSecurityGroup``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `UpdateSecurityGroup`: SecuritySecurityGroup
    fmt.Fprintf(os.Stdout, "Response from `SecurityV1Api.UpdateSecurityGroup`: %v\n", resp)
}
```
...
## UpdateSecurityGroup1

> SecuritySecurityGroup UpdateSecurityGroup1(ctx, oName).Body(body).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.SecurityV1Api.UpdateSecurityGroup1(context.Background(), oName).Body(body).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SecurityV1Api.UpdateSecurityGroup1``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `UpdateSecurityGroup1`: SecuritySecurityGroup
    fmt.Fprintf(os.Stdout, "Response from `SecurityV1Api.UpdateSecurityGroup1`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiUpdateSecurityGroup1Request struct via the builder pattern
...
> SecurityAutoMsgSecurityGroupWatchHelper WatchSecurityGroup(ctx, oTenant).OName(oName).OCreationTime(oCreationTime).FieldChangeSelector(fieldChangeSelector).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.SecurityV1Api.WatchSecurityGroup(context.Background(), oTenant).OName(oName).OCreationTime(oCreationTime).FieldChangeSelector(fieldChangeSelector).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SecurityV1Api.WatchSecurityGroup``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `WatchSecurityGroup`: SecurityAutoMsgSecurityGroupWatchHelper
    fmt.Fprintf(os.Stdout, "Response from `SecurityV1Api.WatchSecurityGroup`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiWatchSecurityGroupRequest struct via the builder pattern
...
> SecurityAutoMsgSecurityGroupWatchHelper WatchSecurityGroup1(ctx).OName(oName).OCreationTime(oCreationTime).FieldChangeSelector(fieldChangeSelector).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.SecurityV1Api.WatchSecurityGroup1(context.Background()).OName(oName).OCreationTime(oCreationTime).FieldChangeSelector(fieldChangeSelector).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SecurityV1Api.WatchSecurityGroup1``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `WatchSecurityGroup1`: SecurityAutoMsgSecurityGroupWatchHelper
    fmt.Fprintf(os.Stdout, "Response from `SecurityV1Api.WatchSecurityGroup1`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiWatchSecurityGroup1Request struct via the builder pattern
