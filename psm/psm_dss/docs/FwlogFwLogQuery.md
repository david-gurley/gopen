...
**PolicyNames** | Pointer to **[]string** | OR of policy names to be matched. Only one policy name is allowed. | [optional] 
...
**Vlans** | Pointer to **[]string** | OR of vlan ids to be matched. Only one vlan id is allowed. | [optional] 
**VpcNames** | Pointer to **[]string** | OR of vpc names to be matched. Only one vpc name is allowed. | [optional] 
