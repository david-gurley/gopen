...
[**LabelClusterProfile**](ClusterV1Api.md#LabelClusterProfile) | **Post** /configs/cluster/v1/clusterprofile/label | Label ClusterProfile object
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.ClusterV1Api.UpdateDistributedServiceEntity(context.Background(), oName).Body(body).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `ClusterV1Api.UpdateDistributedServiceEntity``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `UpdateDistributedServiceEntity`: ClusterDistributedServiceEntity
    fmt.Fprintf(os.Stdout, "Response from `ClusterV1Api.UpdateDistributedServiceEntity`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiUpdateDistributedServiceEntityRequest struct via the builder pattern
...
> ClusterAutoMsgClusterProfileWatchHelper WatchClusterProfile(ctx).OName(oName).OCreationTime(oCreationTime).FieldChangeSelector(fieldChangeSelector).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.ClusterV1Api.WatchClusterProfile(context.Background()).OName(oName).OCreationTime(oCreationTime).FieldChangeSelector(fieldChangeSelector).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `ClusterV1Api.WatchClusterProfile``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `WatchClusterProfile`: ClusterAutoMsgClusterProfileWatchHelper
    fmt.Fprintf(os.Stdout, "Response from `ClusterV1Api.WatchClusterProfile`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiWatchClusterProfileRequest struct via the builder pattern
...
## WatchDistributedServiceEntity

> ClusterAutoMsgDistributedServiceEntityWatchHelper WatchDistributedServiceEntity(ctx).OName(oName).OCreationTime(oCreationTime).FieldChangeSelector(fieldChangeSelector).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.ClusterV1Api.WatchDistributedServiceEntity(context.Background()).OName(oName).OCreationTime(oCreationTime).FieldChangeSelector(fieldChangeSelector).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `ClusterV1Api.WatchDistributedServiceEntity``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `WatchDistributedServiceEntity`: ClusterAutoMsgDistributedServiceEntityWatchHelper
    fmt.Fprintf(os.Stdout, "Response from `ClusterV1Api.WatchDistributedServiceEntity`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiWatchDistributedServiceEntityRequest struct via the builder pattern
